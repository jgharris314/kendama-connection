...
export default function Modal({
  ...
  return (
    ...
    >
      ...
      <div
        id="modal"
        className="absolute w-full lg:w-[66vw] xl:w-[50vw] h-full bg-kenConnect-black right-0 top-0 translate-y-full lg:translate-x-full lg:translate-y-0 duration-500 ease-out transition-all overflow-y-hidden"
      >
        <button
